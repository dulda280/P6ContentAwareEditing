...
if __name__ == '__main__':
    ...
    print("Corner Length", len(data))
    print("Corner Data Mean", np.mean(data))
    print("Corner Data Mean", np.mean(data))
    print("Corner Data Length", len(data))
    print("*************************************************")
    print("Number of edges list", edge_data[0])
    print("Number of edges list Mean", np.mean(edge_data[0]))
    print("Number of edges list Length", len(data))
    print("Largest edges list", edge_data[1])
    print("Largest edges list Mean", np.mean(edge_data[1]))
    print("Largest edges list Length", len(data))
    print("*************************************************")
