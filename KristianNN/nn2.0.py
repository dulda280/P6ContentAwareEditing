...
model = Sequential()
model.add(Conv2D(256, (5,5), kernel_initializer='normal', input_shape = x.shape[1:], activation='relu'))

#model.add(LeakyReLU(alpha=0.01))
model.add(MaxPooling2D(pool_size=(3,3)))
# Another convolutional layer
model.add(Conv2D(128, (5,5),kernel_initializer='normal', activation='relu'))
